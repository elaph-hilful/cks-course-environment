...
kubeadm init --kubernetes-version=${KUBE_VERSION} --ignore-preflight-errors=NumCPU --skip-token-print --pod-network-cidr 10.32.0.0/12
...
### CNI
kubectl apply -f https://raw.githubusercontent.com/elaph-hilful/cks-course-environment/master/cluster-setup/weave.yaml
